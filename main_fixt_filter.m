%% mian script for run fix tmax with filter data
...
for ii = 4:4
    ...
    %                     end
            ...
            if ii == 1 
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/fix_tmax_fliter/sub01';
            elseif ii == 2
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/fix_tmax_fliter/sub02';
            elseif ii == 3
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/fix_tmax_fliter/sub03';
            elseif ii == 4
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/fix_tmax_fliter/sub04';
            elseif ii == 5
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/fix_tmax_fliter/sub05';
            elseif ii == 6
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/fix_tmax_fliter/sub06';
            elseif ii == 7
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/fix_tmax_fliter/sub07';
            elseif ii == 8
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/fix_tmax_fliter/sub08';
            end
