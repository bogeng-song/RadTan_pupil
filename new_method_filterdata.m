%% main script, another way to get our data with filter 
...
%     end
    ...
    for jj = 1: 2
        ...
        for kk = 1:8
            ...
            main_folder2 = fullfile('/scratch/bs4283/rad_tan/Data_DI_wEYE/Data_DI_wEYE', subject{ii}, ...
...
%             trial_end = ones([trial_num,1]);
            ...
            if ii == 1 
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/new_method_filter_fix/sub01';
            elseif ii == 2
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/new_method_filter_fix/sub02';
            elseif ii == 3
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/new_method_filter_fix/sub03';
            elseif ii == 4
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/new_method_filter_fix/sub04';
            elseif ii == 5
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/new_method_filter_fix/sub05';
            elseif ii == 6
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/new_method_filter_fix/sub06';
            elseif ii == 7
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/new_method_filter_fix/sub07';
            elseif ii == 8
                figpath='/scratch/bs4283/rad_tan/multi_methd_result/new_method_filter_fix/sub08';
            end
% 
% 
