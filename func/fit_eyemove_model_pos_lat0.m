function sj = fit_eyemove_model_pos_lat0(eyemovement,event,sample,win,event_label,rt)
...
model.latbounds = repmat([0;500],1,length(model.eventtimes));
model.latbounds(1,1) = -500 ; 
